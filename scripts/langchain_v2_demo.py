# -*- coding: utf-8 -*-
"""
独立演示脚本（原 langchain_v2.py）：
LangGraph 状态机一把梭版（graph.ainvoke/invoke 直接跑，不做 SSE 事件插播）。
运行：python scripts/langchain_v2_demo.py   或   python -m scripts.langchain_v2_demo
"""
import os
...
# ---------- 保证项目根目录在 sys.path 上（直接跑本脚本时能 import agents/tools/config） ----------
